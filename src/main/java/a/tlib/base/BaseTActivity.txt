...
abstract class BaseTActivity(@androidx.annotation.LayoutRes layoutId:Int) : AppCompatActivity(layoutId){
    companion object {
        /**
    ...
    lateinit var act: BaseTActivity
...
//                        .navigationBarDarkIcon(!AppUtil.isDarkColor(navigationBarColor))//导航栏图标浅色
     ...
     * framgent切换
     */
    fun showHideFragment(showTFragment: BaseTFragment, hideTFragment: BaseTFragment? = null, flId: Int = R.id.fl) {
