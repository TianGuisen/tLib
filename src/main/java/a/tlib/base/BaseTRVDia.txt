 ...
 */
abstract class BaseTRVDia<T, B : BaseQuickAdapter<T, out BaseViewHolder>>(@androidx.annotation.LayoutRes layoutId:Int=R.layout.fra_common_list)
    : BaseTDialog<BaseTRVDia<T, B>>(layoutId), IBaseRV<T, B> {
