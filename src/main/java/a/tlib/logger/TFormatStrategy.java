 ...
 * 有边框的log，打印重要信息，网络请求
 */
public class TFormatStrategy implements FormatStrategy {
    ...
    private TFormatStrategy(@NonNull Builder builder) {
    ...
    private int getStackOffset(@NonNull StackTraceElement[] trace) {
        ...
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals("a.tlib.logger.LoggerPrinter") && !name.equals(YLog2.class.getName())) {
                return --i;
            }
        }
        return -1;
    ...
    public static class Builder {
        ...
        @NonNull
        public TFormatStrategy build() {
            if (logStrategy == null) {
                logStrategy = new LogcatLogStrategy();
            }
            return new TFormatStrategy(this);
        }
    }
