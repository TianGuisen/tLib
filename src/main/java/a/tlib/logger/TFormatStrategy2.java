...
import static a.tlib.logger.Utils.checkNotNull;

/**
 * @author 田桂森 2020/2/29
 * 单行简单的log
 */
public class TFormatStrategy2 implements FormatStrategy {
    ...
    private TFormatStrategy2(@NonNull Builder builder) {
...
//            }
        logHeaderContent(priority, tag, methodCount, message);
...
//        logChunk(logType, tag, TOP_BORDER);
    ...
    private void logHeaderContent(int logType, @Nullable String tag, int methodCount, String message) {
...
//        logChunk(logType, tag, MIDDLE_BORDER);
    ...
    private int getStackOffset(@NonNull StackTraceElement[] trace) {
        ...
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals("a.tlib.logger.LoggerPrinter") && !name.equals(YLog.class.getName())) {
                return --i;
            }
        }
        return -1;
    ...
    public static class Builder {
        ...
        @NonNull
        public TFormatStrategy2 build() {
            if (logStrategy == null) {
                logStrategy = new LogcatLogStrategy();
            }
            return new TFormatStrategy2(this);
        }
    }
