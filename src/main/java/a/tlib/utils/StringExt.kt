 ...
 *  是null或者“”
 */
inline fun <T> CharSequence?.isNullOrEmpty(function: () -> T) = isNullOrEmpty().yes(function)
 ...
 *  是null或者“”或者“     ”
 */
inline fun <T> CharSequence?.isNullOrBlank(function: () -> T) = isNullOrBlank().yes(function)
