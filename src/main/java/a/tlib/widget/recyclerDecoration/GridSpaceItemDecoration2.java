...
public class GridSpaceItemDecoration2 extends RecyclerView.ItemDecoration {
    ...
    public GridSpaceItemDecoration2(int spacing) {
        this(spacing, true);
    }
     ...
     */
    public GridSpaceItemDecoration2(int spacing, boolean includeEdge) {
     ...
     */
    @Deprecated
    public GridSpaceItemDecoration2(int spanCount, int spacing) {
     ...
     */
    @Deprecated
    public GridSpaceItemDecoration2(int spanCount, int spacing, boolean includeEdge) {
     ...
     */
    public GridSpaceItemDecoration2 setStartFrom(int startFromSize) {
     ...
     */
    public GridSpaceItemDecoration2 setEndFromSize(int endFromSize) {
     ...
     */
    public GridSpaceItemDecoration2 setNoShowSpace(int startFromSize, int endFromSize) {
        this.mStartFromSize = startFromSize;
        this.mEndFromSize = endFromSize;
        return this;
    }
